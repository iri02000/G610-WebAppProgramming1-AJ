...
# else:
#     print(
#         f"Student {current_student} not found. Please try again using one of the following students: {students}."
#     )
...
# for element in line:
#     line_elements = line.split(" ")
# line_elements = [int(i) for i in line_elements]

# line_elements.sort()
# print(line_elements)

# count = 0
# pos = len(line_elements)
# while line_elements[len(line_elements)] == line_elements[pos]:
#     count = count + 1
#     pos = pos - 1
